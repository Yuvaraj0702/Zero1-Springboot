...
@Entity
@Table
public class LocRoaming {
    @Id
    @SequenceGenerator(
            name = "LocRoaming_sequence",
            sequenceName = "LocRoaming_sequence",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "LocRoaming_sequence"
    )
    private Long ID;
    ...
    public LocRoaming(Long ID, String destination_country, int mincCalled, int mincCalled1, int mincCalled2, int mincCalled3) {
        this.ID = ID;
    ...
    public LocRoaming(String destination_country, int mincCalled, int mincCalled1, int mincCalled2, int mincCalled3) {
        this.Destination_country = destination_country;
        this.MincCalled = mincCalled;
        this.MincCalled1 = mincCalled1;
        this.MincCalled2 = mincCalled2;
