...
@Entity
@Table
public class IntRoaming {
    @Id
    @SequenceGenerator(
            name = "IntRoaming_sequence",
            sequenceName = "IntRoaming_sequence",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "IntRoaming_sequence"
    )
    private Long ID;
    ...
    public IntRoaming(Long ID, String destination_country, int mincCalled, int mincCalled1, int mincCalled2, int mincCalled3) {
        this.ID = ID;
    ...
    public IntRoaming(String destination_country, int mincCalled, int mincCalled1, int mincCalled2, int mincCalled3) {
        this.Destination_country = destination_country;
        this.MincCalled = mincCalled;
        this.MincCalled1 = mincCalled1;
        this.MincCalled2 = mincCalled2;
